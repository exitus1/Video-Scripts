...
- Download ```dcrinstall-linux-arm-v1.6.0```
...
```
cd ./decred/decred-linux-arm-v1.6.0
./dcrd
```

Make sure to change the version number if the current version is no longer v1.6.0 (e.g v1.7.0)
